...
def get_arrivel_date():
    while True:
        data_str = input("Enter arrival date(YYYY-MM-DD): ")
        try:
            arrival_date = datetime.strptime(data_str, "%Y-%m-%d")
        except ValueError:
...
def main():
    ...
    while True:
        ...
        print("Arrical Date: ", arrival_date.strftime(date_format))
